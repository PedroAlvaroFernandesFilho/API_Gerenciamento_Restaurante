...
public class PedidoController {
    ...
    public ResponseEntity<ApiResponse<PedidoDTO>> criarPedido(@Valid @RequestBody PedidoDTO pedidoDTO) {
        try {
            var pedido = pedidoService.criarPedido(pedidoDTO.getReservaId(), pedidoDTO.getItemId(), pedidoDTO.getQuantidade());
    ...
    public ResponseEntity<List<PedidoDTO>> listarPorReserva(@PathVariable Long reservaId) {
